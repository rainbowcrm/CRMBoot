...
public  abstract class HibernateDAO  extends ORMDAO{
    ...
    public static void instantiate(ServletContext ctx) {
    	if (sessionFactory == null) {
    		...
    		configuration.addClass(FiniteValue.class).addResource("hbc/FiniteValue.hbm.xml");
    		configuration.addClass(User.class).addResource("hbc/User.hbm.xml");
    		configuration.addClass(Company.class).addResource("hbc/Company.hbm.xml");
    		configuration.addClass(CRMFilter.class).addResource("hbc/CRMFilter.hbm.xml");
    		configuration.addClass(CRMFilterDetails.class).addResource("hbc/CRMFilterDetails.hbm.xml");
    		configuration.addClass(Division.class).addResource("hbc/Division.hbm.xml");
    		configuration.addClass(Brand.class).addResource("hbc/Brand.hbm.xml");
    		configuration.addClass(Category.class).addResource("hbc/Category.hbm.xml");
    		configuration.addClass(ExpenseHead.class).addResource("hbc/ExpenseHead.hbm.xml");
    		configuration.addClass(Product.class).addResource("hbc/Product.hbm.xml");
    		configuration.addClass(ProductFAQ.class).addResource("hbc/ProductFAQ.hbm.xml");
    		configuration.addClass(ProductPriceRange.class).addResource("hbc/ProductPriceRange.hbm.xml");
    		configuration.addClass(ProductAttribute.class).addResource("hbc/ProductAttribute.hbm.xml");
    		configuration.addClass(UOM.class).addResource("hbc/UOM.hbm.xml");
    		configuration.addClass(Sku.class).addResource("hbc/Sku.hbm.xml");
    		configuration.addClass(Item.class).addResource("hbc/Item.hbm.xml");
    		configuration.addClass(ItemAttribute.class).addResource("hbc/ItemAttribute.hbm.xml");
    		configuration.addClass(Vendor.class).addResource("hbc/Vendor.hbm.xml");
    		configuration.addClass(Carrier.class).addResource("hbc/Carrier.hbm.xml");
    		configuration.addClass(Customer.class).addResource("hbc/Customer.hbm.xml");
    		configuration.addClass(Address.class).addResource("hbc/Address.hbm.xml");
    		configuration.addClass(Inventory.class).addResource("hbc/Inventory.hbm.xml");
    		configuration.addClass(Purchase.class).addResource("hbc/Purchase.hbm.xml");
    		configuration.addClass(PurchaseLine.class).addResource("hbc/PurchaseLine.hbm.xml");
    		configuration.addClass(com.rainbow.framework.query.model.Query.class).addResource("hbc/Query.hbm.xml");
    		configuration.addClass(QueryCondition.class).addResource("hbc/QueryCondition.hbm.xml");
    		configuration.addClass(CorpSalesPeriod.class).addResource("hbc/CorpSalesPeriod.hbm.xml");
    		configuration.addClass(CorpSalesPeriodLine.class).addResource("hbc/CorpSalesPeriodLine.hbm.xml");
    		configuration.addClass(CorpSalesPeriodDivision.class).addResource("hbc/CorpSalesPeriodDivision.hbm.xml");
    		configuration.addClass(CorpSalesPeriodBrand.class).addResource("hbc/CorpSalesPeriodBrand.hbm.xml");
    		configuration.addClass(CorpSalesPeriodCategory.class).addResource("hbc/CorpSalesPeriodCategory.hbm.xml");
    		configuration.addClass(CorpSalesPeriodProduct.class).addResource("hbc/CorpSalesPeriodProduct.hbm.xml");
    		configuration.addClass(SalesPeriod.class).addResource("hbc/SalesPeriod.hbm.xml");
